...
var swiper, scroll_top, product_row;
...
this.searchResult = function(){
    ...
    $(document).on('click','.pop-video', function(e){
        ...
        $('.wrap-slide-album.video-album-pop .iframe-wrp').html("<iframe width='100%' height='100%' src='http://www.youtube.com/embed/"+link+"?autoplay=1'></iframe>");
    });
...
this.trigger_popup_news = function(){
    ...
    if( hash.indexOf("id-youtube") > -1 ){
        ...
        if( id != '' ){
            ...
            $('.wrap-slide-album.video-album-pop .iframe-wrp').html("<iframe width='100%' height='100%' src='http://www.youtube.com/embed/"+id+"?autoplay=1'></iframe>");
        }
        ...
        if( post_id != '' ){
            $.ajax({
                ...
                error: function(errorThrown){loading_ajax = false;}
            });
        }
    }
    location.hash = '';
...
/*end bao*/
    ...
    this.initSwiper = function(){
        ...
        if($("#homepage-slider").length > 0){
            swiper = new Swiper('#homepage-slider .swiper-container.desktop-version', {
